...
def bam_reads(bam,loc,out):
    ...
    for i in a :
        ...
        #         print(line.reference_name,line.pos,line.seq)
            ...
            mo.write(line.seq+'\n')
        mo.close()
# bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/B6_M/sort/Maternal.sort.bam','/public/home/shidetong/wedata/test/Allelic/chip_allelic/rmdup_peak/peak_150bp/peak/B6M_peak.csv','/public/home/shidetong/wedata/meme/allpeak/')
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/B6_M/sort/Paternal.sort.bam','/public/home/shidetong/wedata/test/Allelic/chip_allelic/rmdup_peak/peak_150bp/peak/B6P_peak.csv','/public/home/shidetong/wedata/meme/allpeak/')
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/Cast_M/sort/Maternal.sort.bam','/public/home/shidetong/wedata/test/Allelic/chip_allelic/rmdup_peak/peak_150bp/peak/CastM_peak.csv','/public/home/shidetong/wedata/meme/allpeak/')
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/Cast_M/sort/Paternal.sort.bam','/public/home/shidetong/wedata/test/Allelic/chip_allelic/rmdup_peak/peak_150bp/peak/CastP_peak.csv','/public/home/shidetong/wedata/meme/allpeak/')
...
def bam_reads(bam,loc,out):
    ...
    for i in a :
        ...
        #         print(line.reference_name,line.pos,line.seq)
            ...
            mo.write(line.seq+'\n')
    mo.close()
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/B6_M/sort/Maternal.sort.bam','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/difpeak/B6bais.csv','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/seq/')
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/B6_M/sort/Paternal.sort.bam','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/difpeak/Castbais.csv','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/seq/')
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/Cast_M/sort/Maternal.sort.bam','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/difpeak/Castbais.csv','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/seq/')
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/Cast_M/sort/Paternal.sort.bam','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/difpeak/B6bais.csv','/public/home/shidetong/wedata/meme/bins_all_150bp/dif_B6_Cast/seq/')
#diffbind_peak
bam_reads('/public/home/shidetong/projects/sdt/chip-seq/haplotype/B6_M/sort/Maternal.sort.bam','/public/home/shidetong/wedata/meme/diffbindpeak/difpeak/B6.csv','/public/home/shidetong/wedata/meme/diffbindpeak/seq/')
...
#合并motif
B6loc1 = pd.read_csv('/public/home/shidetong/wedata/meme/bins_all_150bp/B6/new_new_seq/loc1.csv',sep = ',')
B6loc2 = pd.read_csv('/public/home/shidetong/wedata/meme/bins_all_150bp/B6/new_new_seq/loc2.csv',sep = ',')
Castloc1 = pd.read_csv('/public/home/shidetong/wedata/meme/bins_all_150bp/Cast/new_new_seq/loc_1.csv',sep = ',')
Castloc2 = pd.read_csv('/public/home/shidetong/wedata/meme/bins_all_150bp/Cast/new_new_seq/loc_2.csv',sep = ',')
B6loc1 = B6loc1.iloc[6:10,0:34]
B6loc1.index = ['BCF1_B6','BCF1_Cast','CBF1_Cast','CBF1_B6']
B6loc2 = B6loc2.iloc[6:10,0:34]
B6loc2.index = ['BCF1_B6','BCF1_Cast','CBF1_Cast','CBF1_B6']
Castloc1 = Castloc1.iloc[5:9,:]
Castloc1.index = ['BCF1_B6','BCF1_Cast','CBF1_Cast','CBF1_B6']
Castloc2 = Castloc2.iloc[6:10,0:5]
Castloc2.index = ['BCF1_B6','BCF1_Cast','CBF1_Cast','CBF1_B6']
all = pd.concat([B6loc1,B6loc2,Castloc1,Castloc2],axis = 1)
all.to_csv('/public/home/shidetong/wedata/meme/bins_all_150bp/base_ratio/all_seq.csv')
